...
class LayoutBuilderSampleEntityGenerator implements SampleEntityGeneratorInterface {
  ...
  public function get($entity_type_id, $bundle_id) {
    ...
    // Indicate that this entity is constructed with sample data.
    // This informs downstream code that the entity provided in the context
    // is not complete (has sample data).
    $entity->has_sample_data = TRUE;
