...
interface StreamWrapperInterface {
   ...
   * closed while any unflushed data has been written to it before. If you have
   ...
   * Read from stream.
   *
   * This method is called in response to fread() and fgets(). Remember to
   * update the read/write position of the stream (by the number of bytes that
   ...
   * will call `streamWrapper::stream_read()` followed by
   * `streamWrapper::stream_eof()` in a loop but as long as
   * `streamWrapper::stream_read()` returns a non-empty string, the return
   * value of `streamWrapper::stream_eof()` is ignored.
   *
   * @param int $count
  ...
  /**
   * Get the type of stream wrapper.
   *
   * @return int
   *   Return the type of stream wrapper.
   */
