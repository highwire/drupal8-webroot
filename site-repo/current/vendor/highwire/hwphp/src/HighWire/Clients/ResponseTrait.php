...
/**
 * Using this trait allows you to implement Psr\Http\Message\ResponseInterface.
 */
trait ResponseTrait {
  private $response;
   ...
   *   A an object that implements a response interface.
   */
   ...
   *
   * @throws \InvalidArgumentException
   *   Thows for invalid header names or values.
   */
