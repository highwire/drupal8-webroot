...
use TransferTokenClient\Api\TokenRequestsApi;
use TransferTokenClient\Configuration;


/**
 * TokenRequest Client Class.
 */
class TokenRequest extends Client {

  /**
   * Transfer Token swagger client
   *
   * @var \TransferTokenClient\Api\AuthRequestsApi
   */
  ...
  public function __construct(GuzzleClient $http_client, array $config = []) {
    ...
    $this->authRequestSwaggerClient = new TokenRequestsApi($this->httpClient, $swagger_config);
  }
