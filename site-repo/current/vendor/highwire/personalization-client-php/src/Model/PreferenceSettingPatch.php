...
/**
 * PreferenceSettingPatch Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PreferenceSettingPatch implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PreferenceSettingPatch';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['setting_values'] === null) {
            $invalidProperties[] = "'setting_values' can't be null";
        }
     ...
     * Sets setting_values
     *
     * @param string[] $setting_values setting_values
     *
     * @return $this
     */
