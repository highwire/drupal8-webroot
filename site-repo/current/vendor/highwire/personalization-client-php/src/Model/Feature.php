 ...
 *
 * @category Class
 * @description Describes the p13n feature including any settings / labels used by the UI.
 * @package  PersonalizationClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Feature implements ModelInterface, ArrayAccess
{
     ...
     * Sets settings
     *
     * @param \PersonalizationClient\Model\Settings $settings The setting values from the AlertsUI feature
     *
     * @return $this
     */
